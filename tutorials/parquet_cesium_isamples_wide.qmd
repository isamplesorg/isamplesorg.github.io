...
::: {.callout-note}
## iSamples Full Dataset (Wide Format + H3 Spatial Index)
...
```{ojs}
//| echo: false
// View mode toggle: clustered (H3 LOD) vs all points
viewof viewModeToggle = Inputs.radio(["clustered", "all points"], {
  label: "View Mode:",
  value: "clustered"
})
```
