...
Compare with [OpenContext-only Cesium View](/tutorials/parquet_cesium_wide.html) (275 MB, ~2.5M rows).
:::
...
- [Cesium View (OpenContext Wide)](/tutorials/parquet_cesium_wide.html) - OpenContext-only data (275 MB)
- [Cesium View (Narrow)](/tutorials/parquet_cesium.html) - Narrow schema visualization
