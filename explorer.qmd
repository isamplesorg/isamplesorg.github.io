...
directly inventories 21 files and separately summarizes the sharded search index
(256 base shards plus hot-token sub-files, ~852 objects including sidecars); any
one view touches only a handful of them. The authoritative inventory is
