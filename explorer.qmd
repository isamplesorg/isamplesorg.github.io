...
function viewerBboxSQL(latCol, lngCol, padFactor) {
    ...
    if (padFactor && padFactor > 0) {
        ...
        // For longitude span when the rect wraps the antimeridian, the span
        // is (180 - west) + (east - (-180)); otherwise east - west.
        const lngSpan = (west > east) ? (180 - west) + (east + 180) : east - west;
