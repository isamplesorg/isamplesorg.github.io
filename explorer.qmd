...
// #171: substrate query engine (feature-flagged ?fts=v1 — see
// buildSearchFilterSubstrate). Pure planning/scoring logic lives in the
// module (Node-unit-tested); the explorer only wires it to DuckDB.
_searchSubstrate = await import(new URL('assets/js/search_substrate.js', document.baseURI).href)
