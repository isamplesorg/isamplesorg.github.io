...
zoomWatcher = {
    ...
    async function doSearch(scope) {
        ...
        if (!term || term.length < 2) {
            ...
            // search — drop the pid-set filter and refresh surfaces so they
            // revert to the unfiltered "match the current filters" state.
        ...
        if (searchId === _searchSeq && typeof window !== 'undefined') {
