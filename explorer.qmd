...
zoomWatcher = {
    ...
    function invalidateFacetCountsNow() {
        ...
        ++facetCountsReqId;
        // Under an active search the counts are already the honest "(—)" dash
        // (#340). Re-dimming them would downgrade "we cannot know this" to
        // "we're about to know it", which is a worse claim, not a better one.
