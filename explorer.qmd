...
zoomWatcher = {
    ...
    async function buildSearchFilter(terms, term) {
        ...
        await db.query(`
            CREATE OR REPLACE TABLE search_pids_next AS
        ...
        await db.query(`CREATE OR REPLACE TABLE search_pids AS
            SELECT pid, label, source, place_name, relevance_score FROM search_pids_next`);
    ...
    async function clearSearchFilter() {
        ...
        try { await db.query(`DROP TABLE IF EXISTS search_pids`); } catch (e) { /* best effort */ }
    }
