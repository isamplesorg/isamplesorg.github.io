...
tableView = {
    ...
    function updatePagerEdges() {
        ...
        if (nextBtn) {
            const atEnd = totalRows != null && currentPage >= totalPagesFor(totalRows) - 1;
    ...
    function renderTable() {
        ...
        if (!tableEl) return;
        if (pageRows.length === 0 && totalRows === 0) {
    ...
    async function loadPage(p, genAtStart) {
        try {
