...
This spec has not kept pace with the shipped Explorer in two ways. Both are
recorded rather than silently corrected, because fixing them properly means
re-stating semantics, not renaming strings:
...
Treat the *shape* of the bindings as current and the *filenames and text-search
narrative* as historical until this is revised.
:::
